            ...
            <nav className="p-5 bg-white shadow md:flex md:items-center md:justify-between relative">
                <divc className="flex justify-between items-center">
                    ...
                    <span className="text-3xl cursor-pointer md:hidden">
                        <TiThMenu className="text-3xl md:hidden absolute right-8 top-6 cursor-pointer" onClick={handleClick}/>
                    </span>
                </divc>
                <ul
                    className="md:flex md:items-center z-10 md:z-auto md:static absolute bg-white w-full left-0 md:w-auto md:py-0 py-6 md:pl-0 pl-7 md:opacity-100 opacity-0 top-[-400px] transition-all ease-in-out duration-500 md:shadow-none shadow-lg "
                >
